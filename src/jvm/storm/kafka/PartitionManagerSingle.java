...
public class PartitionManagerSingle implements PartitionManager {
    public static final Logger LOG = LoggerFactory
            .getLogger(PartitionManagerSingle.class);
    ...
    public PartitionManagerSingle(DynamicPartitionConnections connections,
