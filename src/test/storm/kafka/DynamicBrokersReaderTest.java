...
public class DynamicBrokersReaderTest {
	...
	public void setUp() throws Exception {
		...
		zookeeper = CuratorFrameworkFactory.newClient(connectionString,
				retryPolicy);
		dynamicBrokersReader = new DynamicBrokersReader(conf, connectionString,
				masterPath, topic);
		zookeeper.start();
	}
	...
	private void writeLeader(int id, int leaderId) throws Exception {
		String path = dynamicBrokersReader.partitionPath() + "/" + id
				+ "/state";
	...
	public void testGetBrokerInfo() throws Exception {
		...
		GlobalPartitionInformation brokerInfo = dynamicBrokersReader
				.getBrokerInfo();
