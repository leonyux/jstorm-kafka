...
public class StringKeyValueSchemeTest {
    ...
    public void testDeserialize() throws Exception {
        assertEquals(Arrays.asList("test"),
                scheme.deserialize("test".getBytes()));
    }
    ...
    public void testDeserializeWithNullKeyAndValue() throws Exception {
        assertEquals(Arrays.asList("test"),
                scheme.deserializeKeyAndValue(null, "test".getBytes()));
    }

    @Test
    public void testDeserializeWithKeyAndValue() throws Exception {
        assertEquals(
                Arrays.asList(ImmutableMap.of("key", "test")),
                scheme.deserializeKeyAndValue("key".getBytes(),
                        "test".getBytes()));
    }
}
